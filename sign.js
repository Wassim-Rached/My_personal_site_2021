...
function checkInputs() {
	...
	if(password2Value.length < 8) {
		setErrorFor(password2, 'your password must be at least 8 characters');
...
function checkIfSignInSucceed(){
    if (document.querySelectorAll('.success').length == 4) {
        document.getElementById('signInSucceed').style.display = "flex"
    }
