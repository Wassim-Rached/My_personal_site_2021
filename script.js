window.addEventListener("scroll",function () {
  ...
  navHome.classList.toggle('active', window.scrollY >= 0 && window.scrollY < 381)
  navContact.classList.toggle('active', window.scrollY > 382 && window.scrollY < 1275)
  navAbout.classList.toggle('active', window.scrollY > 1276 && window.scrollY < 2213)
